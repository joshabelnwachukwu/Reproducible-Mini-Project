...
#access cleaned data file and set output directory for analysis script 
cleandata_csv <- file.path("02_outdata", "penguins_clean.csv")
outdir    <- "02_outdata"
dir.create(outdir, showWarnings = FALSE, recursive = TRUE)

#output directory for supplementary files created durinf data analysis
